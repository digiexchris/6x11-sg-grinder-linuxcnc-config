...
typedef struct {
    ...
    hal_float_t *SIGIN_SPINDLE_RPM_IN_FREQUENCY;
    hal_float_t *SIGIN_SPINDLE_RPM_IN_FREQUENCY_ABS;
    hal_s32_t *SIGIN_SPINDLE_RPM_IN_FREQUENCY_S32;
    hal_u32_t *SIGIN_SPINDLE_RPM_IN_FREQUENCY_U32_ABS;
    hal_float_t *SIGIN_SPINDLE_RPM_IN_FREQUENCY_SCALE;
    hal_float_t *SIGIN_SPINDLE_RPM_IN_FREQUENCY_OFFSET;
    hal_bit_t   *SIGIN_SPINDLE_RPM_IN_VALID;
    hal_bit_t   *SIGIN_SPINDLE_RPM_IN_VALID_not;
    hal_float_t *SIGOUT_SPINDLE_SPEED_PWM_OUT_DTY;
    hal_float_t *SIGOUT_SPINDLE_SPEED_PWM_OUT_DTY_SCALE;
    hal_float_t *SIGOUT_SPINDLE_SPEED_PWM_OUT_DTY_OFFSET;
    hal_bit_t   *SIGOUT_SPINDLE_SPEED_PWM_OUT_ENABLE;
    hal_float_t *SIGOUT_ZSTEPPER_VELOCITY;
    hal_float_t *SIGOUT_ZSTEPPER_VELOCITY_SCALE;
    hal_float_t *SIGOUT_ZSTEPPER_VELOCITY_OFFSET;
    hal_float_t *SIGIN_ZSTEPPER_POSITION;
    hal_float_t *SIGIN_ZSTEPPER_POSITION_ABS;
    hal_s32_t *SIGIN_ZSTEPPER_POSITION_S32;
    hal_u32_t *SIGIN_ZSTEPPER_POSITION_U32_ABS;
    hal_float_t *SIGIN_ZSTEPPER_POSITION_SCALE;
    hal_float_t *SIGIN_ZSTEPPER_POSITION_OFFSET;
    hal_bit_t   *SIGOUT_ZSTEPPER_ENABLE;
    hal_float_t *SIGOUT_YSTEPPER_VELOCITY;
    hal_float_t *SIGOUT_YSTEPPER_VELOCITY_SCALE;
    hal_float_t *SIGOUT_YSTEPPER_VELOCITY_OFFSET;
    hal_float_t *SIGIN_YSTEPPER_POSITION;
    hal_float_t *SIGIN_YSTEPPER_POSITION_ABS;
    hal_s32_t *SIGIN_YSTEPPER_POSITION_S32;
    hal_u32_t *SIGIN_YSTEPPER_POSITION_U32_ABS;
    hal_float_t *SIGIN_YSTEPPER_POSITION_SCALE;
    hal_float_t *SIGIN_YSTEPPER_POSITION_OFFSET;
    hal_bit_t   *SIGOUT_YSTEPPER_ENABLE;
    hal_float_t *SIGOUT_XSTEPPER_VELOCITY;
    hal_float_t *SIGOUT_XSTEPPER_VELOCITY_SCALE;
    hal_float_t *SIGOUT_XSTEPPER_VELOCITY_OFFSET;
    hal_float_t *SIGIN_XSTEPPER_POSITION;
    hal_float_t *SIGIN_XSTEPPER_POSITION_ABS;
    hal_s32_t *SIGIN_XSTEPPER_POSITION_S32;
    hal_u32_t *SIGIN_XSTEPPER_POSITION_U32_ABS;
    hal_float_t *SIGIN_XSTEPPER_POSITION_SCALE;
    hal_float_t *SIGIN_XSTEPPER_POSITION_OFFSET;
    hal_bit_t   *SIGOUT_XSTEPPER_ENABLE;
    hal_bit_t   *SIGIN_ESTOP_BIT;
    hal_bit_t   *SIGIN_ESTOP_BIT_not;
    hal_bit_t   *SIGIN_ZHOME_BIT;
    hal_bit_t   *SIGIN_ZHOME_BIT_not;
    hal_bit_t   *SIGIN_YHOME_BIT;
    hal_bit_t   *SIGIN_YHOME_BIT_not;
    hal_bit_t   *SIGIN_XHOME_BIT;
    hal_bit_t   *SIGIN_XHOME_BIT_not;
    // raw variables
    int32_t VARIN32_FREQIN1_FREQUENCY;
    int32_t VAROUT32_PWMOUT2_DTY;
    ...
    bool VARIN1_FREQIN1_VALID;
    bool VAROUT1_PWMOUT2_ENABLE;
...
void register_signals(void) {
    int retval = 0;
    data->VARIN32_FREQIN1_FREQUENCY = 0;
    data->VAROUT32_PWMOUT2_DTY = 0;
    ...
    data->VARIN1_FREQIN1_VALID = 0;
    data->VAROUT1_PWMOUT2_ENABLE = 0;
    ...
    *data->duration = rtapi_get_time();
    if (retval = hal_pin_float_newf(HAL_IN, &(data->SIGIN_SPINDLE_RPM_IN_FREQUENCY_SCALE), comp_id, "%s.SPINDLE_RPM_IN.frequency-scale", prefix) != 0) error_handler(retval);
    *data->SIGIN_SPINDLE_RPM_IN_FREQUENCY_SCALE = 1.0;
    if (retval = hal_pin_float_newf(HAL_IN, &(data->SIGIN_SPINDLE_RPM_IN_FREQUENCY_OFFSET), comp_id, "%s.SPINDLE_RPM_IN.frequency-offset", prefix) != 0) error_handler(retval);
    *data->SIGIN_SPINDLE_RPM_IN_FREQUENCY_OFFSET = 0.0;
    if (retval = hal_pin_float_newf(HAL_OUT, &(data->SIGIN_SPINDLE_RPM_IN_FREQUENCY), comp_id, "%s.SPINDLE_RPM_IN.frequency", prefix) != 0) error_handler(retval);
    *data->SIGIN_SPINDLE_RPM_IN_FREQUENCY = 0;
    if (retval = hal_pin_float_newf(HAL_OUT, &(data->SIGIN_SPINDLE_RPM_IN_FREQUENCY_ABS), comp_id, "%s.SPINDLE_RPM_IN.frequency-abs", prefix) != 0) error_handler(retval);
    *data->SIGIN_SPINDLE_RPM_IN_FREQUENCY_ABS = 0;
    if (retval = hal_pin_s32_newf(HAL_OUT, &(data->SIGIN_SPINDLE_RPM_IN_FREQUENCY_S32), comp_id, "%s.SPINDLE_RPM_IN.frequency-s32", prefix) != 0) error_handler(retval);
    *data->SIGIN_SPINDLE_RPM_IN_FREQUENCY_S32 = 0;
    if (retval = hal_pin_u32_newf(HAL_OUT, &(data->SIGIN_SPINDLE_RPM_IN_FREQUENCY_U32_ABS), comp_id, "%s.SPINDLE_RPM_IN.frequency-u32-abs", prefix) != 0) error_handler(retval);
    *data->SIGIN_SPINDLE_RPM_IN_FREQUENCY_U32_ABS = 0;
    if (retval = hal_pin_bit_newf  (HAL_OUT, &(data->SIGIN_SPINDLE_RPM_IN_VALID), comp_id, "%s.SPINDLE_RPM_IN.valid", prefix) != 0) error_handler(retval);
    *data->SIGIN_SPINDLE_RPM_IN_VALID = 0;
    if (retval = hal_pin_bit_newf  (HAL_OUT, &(data->SIGIN_SPINDLE_RPM_IN_VALID_not), comp_id, "%s.SPINDLE_RPM_IN.valid-not", prefix) != 0) error_handler(retval);
    *data->SIGIN_SPINDLE_RPM_IN_VALID_not = 1 - *data->SIGIN_SPINDLE_RPM_IN_VALID;
    if (retval = hal_pin_float_newf(HAL_IN, &(data->SIGOUT_SPINDLE_SPEED_PWM_OUT_DTY_SCALE), comp_id, "%s.SPINDLE_SPEED_PWM_OUT.dty-scale", prefix) != 0) error_handler(retval);
    *data->SIGOUT_SPINDLE_SPEED_PWM_OUT_DTY_SCALE = 1.0;
    if (retval = hal_pin_float_newf(HAL_IN, &(data->SIGOUT_SPINDLE_SPEED_PWM_OUT_DTY_OFFSET), comp_id, "%s.SPINDLE_SPEED_PWM_OUT.dty-offset", prefix) != 0) error_handler(retval);
    *data->SIGOUT_SPINDLE_SPEED_PWM_OUT_DTY_OFFSET = 0.0;
    if (retval = hal_pin_float_newf(HAL_IN, &(data->SIGOUT_SPINDLE_SPEED_PWM_OUT_DTY), comp_id, "%s.SPINDLE_SPEED_PWM_OUT.dty", prefix) != 0) error_handler(retval);
    *data->SIGOUT_SPINDLE_SPEED_PWM_OUT_DTY = 0;
    if (retval = hal_pin_bit_newf  (HAL_IN, &(data->SIGOUT_SPINDLE_SPEED_PWM_OUT_ENABLE), comp_id, "%s.SPINDLE_SPEED_PWM_OUT.enable", prefix) != 0) error_handler(retval);
    *data->SIGOUT_SPINDLE_SPEED_PWM_OUT_ENABLE = 0;
    if (retval = hal_pin_float_newf(HAL_IN, &(data->SIGOUT_ZSTEPPER_VELOCITY_SCALE), comp_id, "%s.ZStepper.velocity-scale", prefix) != 0) error_handler(retval);
    *data->SIGOUT_ZSTEPPER_VELOCITY_SCALE = 1.0;
    if (retval = hal_pin_float_newf(HAL_IN, &(data->SIGOUT_ZSTEPPER_VELOCITY_OFFSET), comp_id, "%s.ZStepper.velocity-offset", prefix) != 0) error_handler(retval);
    *data->SIGOUT_ZSTEPPER_VELOCITY_OFFSET = 0.0;
    if (retval = hal_pin_float_newf(HAL_IN, &(data->SIGOUT_ZSTEPPER_VELOCITY), comp_id, "%s.ZStepper.velocity", prefix) != 0) error_handler(retval);
    *data->SIGOUT_ZSTEPPER_VELOCITY = 0;
    if (retval = hal_pin_float_newf(HAL_IN, &(data->SIGIN_ZSTEPPER_POSITION_SCALE), comp_id, "%s.ZStepper.position-scale", prefix) != 0) error_handler(retval);
    *data->SIGIN_ZSTEPPER_POSITION_SCALE = 1.0;
    if (retval = hal_pin_float_newf(HAL_IN, &(data->SIGIN_ZSTEPPER_POSITION_OFFSET), comp_id, "%s.ZStepper.position-offset", prefix) != 0) error_handler(retval);
    *data->SIGIN_ZSTEPPER_POSITION_OFFSET = 0.0;
    if (retval = hal_pin_float_newf(HAL_OUT, &(data->SIGIN_ZSTEPPER_POSITION), comp_id, "%s.ZStepper.position", prefix) != 0) error_handler(retval);
    *data->SIGIN_ZSTEPPER_POSITION = 0;
    if (retval = hal_pin_float_newf(HAL_OUT, &(data->SIGIN_ZSTEPPER_POSITION_ABS), comp_id, "%s.ZStepper.position-abs", prefix) != 0) error_handler(retval);
    *data->SIGIN_ZSTEPPER_POSITION_ABS = 0;
    if (retval = hal_pin_s32_newf(HAL_OUT, &(data->SIGIN_ZSTEPPER_POSITION_S32), comp_id, "%s.ZStepper.position-s32", prefix) != 0) error_handler(retval);
    *data->SIGIN_ZSTEPPER_POSITION_S32 = 0;
    if (retval = hal_pin_u32_newf(HAL_OUT, &(data->SIGIN_ZSTEPPER_POSITION_U32_ABS), comp_id, "%s.ZStepper.position-u32-abs", prefix) != 0) error_handler(retval);
    *data->SIGIN_ZSTEPPER_POSITION_U32_ABS = 0;
    if (retval = hal_pin_bit_newf  (HAL_IN, &(data->SIGOUT_ZSTEPPER_ENABLE), comp_id, "%s.ZStepper.enable", prefix) != 0) error_handler(retval);
    *data->SIGOUT_ZSTEPPER_ENABLE = 0;
    if (retval = hal_pin_float_newf(HAL_IN, &(data->SIGOUT_YSTEPPER_VELOCITY_SCALE), comp_id, "%s.YStepper.velocity-scale", prefix) != 0) error_handler(retval);
    *data->SIGOUT_YSTEPPER_VELOCITY_SCALE = 1.0;
    if (retval = hal_pin_float_newf(HAL_IN, &(data->SIGOUT_YSTEPPER_VELOCITY_OFFSET), comp_id, "%s.YStepper.velocity-offset", prefix) != 0) error_handler(retval);
    *data->SIGOUT_YSTEPPER_VELOCITY_OFFSET = 0.0;
    if (retval = hal_pin_float_newf(HAL_IN, &(data->SIGOUT_YSTEPPER_VELOCITY), comp_id, "%s.YStepper.velocity", prefix) != 0) error_handler(retval);
    *data->SIGOUT_YSTEPPER_VELOCITY = 0;
    if (retval = hal_pin_float_newf(HAL_IN, &(data->SIGIN_YSTEPPER_POSITION_SCALE), comp_id, "%s.YStepper.position-scale", prefix) != 0) error_handler(retval);
    *data->SIGIN_YSTEPPER_POSITION_SCALE = 1.0;
    if (retval = hal_pin_float_newf(HAL_IN, &(data->SIGIN_YSTEPPER_POSITION_OFFSET), comp_id, "%s.YStepper.position-offset", prefix) != 0) error_handler(retval);
    *data->SIGIN_YSTEPPER_POSITION_OFFSET = 0.0;
    if (retval = hal_pin_float_newf(HAL_OUT, &(data->SIGIN_YSTEPPER_POSITION), comp_id, "%s.YStepper.position", prefix) != 0) error_handler(retval);
    *data->SIGIN_YSTEPPER_POSITION = 0;
    if (retval = hal_pin_float_newf(HAL_OUT, &(data->SIGIN_YSTEPPER_POSITION_ABS), comp_id, "%s.YStepper.position-abs", prefix) != 0) error_handler(retval);
    *data->SIGIN_YSTEPPER_POSITION_ABS = 0;
    if (retval = hal_pin_s32_newf(HAL_OUT, &(data->SIGIN_YSTEPPER_POSITION_S32), comp_id, "%s.YStepper.position-s32", prefix) != 0) error_handler(retval);
    *data->SIGIN_YSTEPPER_POSITION_S32 = 0;
    if (retval = hal_pin_u32_newf(HAL_OUT, &(data->SIGIN_YSTEPPER_POSITION_U32_ABS), comp_id, "%s.YStepper.position-u32-abs", prefix) != 0) error_handler(retval);
    *data->SIGIN_YSTEPPER_POSITION_U32_ABS = 0;
    if (retval = hal_pin_bit_newf  (HAL_IN, &(data->SIGOUT_YSTEPPER_ENABLE), comp_id, "%s.YStepper.enable", prefix) != 0) error_handler(retval);
    *data->SIGOUT_YSTEPPER_ENABLE = 0;
    if (retval = hal_pin_float_newf(HAL_IN, &(data->SIGOUT_XSTEPPER_VELOCITY_SCALE), comp_id, "%s.XStepper.velocity-scale", prefix) != 0) error_handler(retval);
    *data->SIGOUT_XSTEPPER_VELOCITY_SCALE = 1.0;
    if (retval = hal_pin_float_newf(HAL_IN, &(data->SIGOUT_XSTEPPER_VELOCITY_OFFSET), comp_id, "%s.XStepper.velocity-offset", prefix) != 0) error_handler(retval);
    *data->SIGOUT_XSTEPPER_VELOCITY_OFFSET = 0.0;
    if (retval = hal_pin_float_newf(HAL_IN, &(data->SIGOUT_XSTEPPER_VELOCITY), comp_id, "%s.XStepper.velocity", prefix) != 0) error_handler(retval);
    *data->SIGOUT_XSTEPPER_VELOCITY = 0;
    if (retval = hal_pin_float_newf(HAL_IN, &(data->SIGIN_XSTEPPER_POSITION_SCALE), comp_id, "%s.XStepper.position-scale", prefix) != 0) error_handler(retval);
    *data->SIGIN_XSTEPPER_POSITION_SCALE = 1.0;
    if (retval = hal_pin_float_newf(HAL_IN, &(data->SIGIN_XSTEPPER_POSITION_OFFSET), comp_id, "%s.XStepper.position-offset", prefix) != 0) error_handler(retval);
    *data->SIGIN_XSTEPPER_POSITION_OFFSET = 0.0;
    if (retval = hal_pin_float_newf(HAL_OUT, &(data->SIGIN_XSTEPPER_POSITION), comp_id, "%s.XStepper.position", prefix) != 0) error_handler(retval);
    *data->SIGIN_XSTEPPER_POSITION = 0;
    if (retval = hal_pin_float_newf(HAL_OUT, &(data->SIGIN_XSTEPPER_POSITION_ABS), comp_id, "%s.XStepper.position-abs", prefix) != 0) error_handler(retval);
    *data->SIGIN_XSTEPPER_POSITION_ABS = 0;
    if (retval = hal_pin_s32_newf(HAL_OUT, &(data->SIGIN_XSTEPPER_POSITION_S32), comp_id, "%s.XStepper.position-s32", prefix) != 0) error_handler(retval);
    *data->SIGIN_XSTEPPER_POSITION_S32 = 0;
    if (retval = hal_pin_u32_newf(HAL_OUT, &(data->SIGIN_XSTEPPER_POSITION_U32_ABS), comp_id, "%s.XStepper.position-u32-abs", prefix) != 0) error_handler(retval);
    *data->SIGIN_XSTEPPER_POSITION_U32_ABS = 0;
    if (retval = hal_pin_bit_newf  (HAL_IN, &(data->SIGOUT_XSTEPPER_ENABLE), comp_id, "%s.XStepper.enable", prefix) != 0) error_handler(retval);
    *data->SIGOUT_XSTEPPER_ENABLE = 0;
    if (retval = hal_pin_bit_newf  (HAL_OUT, &(data->SIGIN_ESTOP_BIT), comp_id, "%s.ESTOP.bit", prefix) != 0) error_handler(retval);
    *data->SIGIN_ESTOP_BIT = 0;
    if (retval = hal_pin_bit_newf  (HAL_OUT, &(data->SIGIN_ESTOP_BIT_not), comp_id, "%s.ESTOP.bit-not", prefix) != 0) error_handler(retval);
    *data->SIGIN_ESTOP_BIT_not = 1 - *data->SIGIN_ESTOP_BIT;
    if (retval = hal_pin_bit_newf  (HAL_OUT, &(data->SIGIN_ZHOME_BIT), comp_id, "%s.ZHOME.bit", prefix) != 0) error_handler(retval);
    *data->SIGIN_ZHOME_BIT = 0;
    if (retval = hal_pin_bit_newf  (HAL_OUT, &(data->SIGIN_ZHOME_BIT_not), comp_id, "%s.ZHOME.bit-not", prefix) != 0) error_handler(retval);
    *data->SIGIN_ZHOME_BIT_not = 1 - *data->SIGIN_ZHOME_BIT;
    if (retval = hal_pin_bit_newf  (HAL_OUT, &(data->SIGIN_YHOME_BIT), comp_id, "%s.YHOME.bit", prefix) != 0) error_handler(retval);
    *data->SIGIN_YHOME_BIT = 0;
    if (retval = hal_pin_bit_newf  (HAL_OUT, &(data->SIGIN_YHOME_BIT_not), comp_id, "%s.YHOME.bit-not", prefix) != 0) error_handler(retval);
    *data->SIGIN_YHOME_BIT_not = 1 - *data->SIGIN_YHOME_BIT;
    if (retval = hal_pin_bit_newf  (HAL_OUT, &(data->SIGIN_XHOME_BIT), comp_id, "%s.XHOME.bit", prefix) != 0) error_handler(retval);
    *data->SIGIN_XHOME_BIT = 0;
    if (retval = hal_pin_bit_newf  (HAL_OUT, &(data->SIGIN_XHOME_BIT_not), comp_id, "%s.XHOME.bit-not", prefix) != 0) error_handler(retval);
    *data->SIGIN_XHOME_BIT_not = 1 - *data->SIGIN_XHOME_BIT;
}
...
void convert_varout32_pwmout2_dty(data_t *data){
    float value = *data->SIGOUT_SPINDLE_SPEED_PWM_OUT_DTY;
    value = value * *data->SIGOUT_SPINDLE_SPEED_PWM_OUT_DTY_SCALE;
    value = value + *data->SIGOUT_SPINDLE_SPEED_PWM_OUT_DTY_OFFSET;
    value = (value - 0) * (OSC_CLOCK / 10000) / (100 - 0);
    data->VAROUT32_PWMOUT2_DTY = value;
}

void convert_varout1_pwmout2_enable(data_t *data){
    bool value = *data->SIGOUT_SPINDLE_SPEED_PWM_OUT_ENABLE;
    
    data->VAROUT1_PWMOUT2_ENABLE = value;
}

void convert_varout32_stepdir3_velocity(data_t *data){
    float value = *data->SIGOUT_ZSTEPPER_VELOCITY;
    value = value * *data->SIGOUT_ZSTEPPER_VELOCITY_SCALE;
    value = value + *data->SIGOUT_ZSTEPPER_VELOCITY_OFFSET;
    if (value != 0) {
...
void convert_varout1_stepdir3_enable(data_t *data){
    bool value = *data->SIGOUT_ZSTEPPER_ENABLE;
    
    data->VAROUT1_STEPDIR3_ENABLE = value;
}

void convert_varout32_stepdir4_velocity(data_t *data){
    float value = *data->SIGOUT_YSTEPPER_VELOCITY;
    value = value * *data->SIGOUT_YSTEPPER_VELOCITY_SCALE;
    value = value + *data->SIGOUT_YSTEPPER_VELOCITY_OFFSET;
    if (value != 0) {
                value = OSC_CLOCK / value / 2;
            }
...
void convert_varout1_stepdir4_enable(data_t *data){
    bool value = *data->SIGOUT_YSTEPPER_ENABLE;
    
    data->VAROUT1_STEPDIR4_ENABLE = value;
}

void convert_varout32_stepdir5_velocity(data_t *data){
    float value = *data->SIGOUT_XSTEPPER_VELOCITY;
    value = value * *data->SIGOUT_XSTEPPER_VELOCITY_SCALE;
    value = value + *data->SIGOUT_XSTEPPER_VELOCITY_OFFSET;
    if (value != 0) {
                value = OSC_CLOCK / value / 2;
            }
...
void convert_varout1_stepdir5_enable(data_t *data){
    bool value = *data->SIGOUT_XSTEPPER_ENABLE;
...
void convert_sigin_spindle_rpm_in_frequency(data_t *data) {
    float value = data->VARIN32_FREQIN1_FREQUENCY;
    if (value != 0) {
            value = OSC_CLOCK / value;
        }
    float offset = *data->SIGIN_SPINDLE_RPM_IN_FREQUENCY_OFFSET;
    float scale = *data->SIGIN_SPINDLE_RPM_IN_FREQUENCY_SCALE;
    float last_value = *data->SIGIN_SPINDLE_RPM_IN_FREQUENCY;
    static float last_raw_value = 0.0;
    float raw_value = value;
    value = value + offset;
    value = value / scale;
    *data->SIGIN_SPINDLE_RPM_IN_FREQUENCY_ABS = abs(value);
    *data->SIGIN_SPINDLE_RPM_IN_FREQUENCY_S32 = value;
    *data->SIGIN_SPINDLE_RPM_IN_FREQUENCY_U32_ABS = abs(value);
    *data->SIGIN_SPINDLE_RPM_IN_FREQUENCY = value;

    last_raw_value = raw_value;
}

void convert_sigin_spindle_rpm_in_valid(data_t *data) {
    bool value = data->VARIN1_FREQIN1_VALID;
    if (value != 0) {
            value = OSC_CLOCK / value;
        }
    *data->SIGIN_SPINDLE_RPM_IN_VALID = value;
    *data->SIGIN_SPINDLE_RPM_IN_VALID_not = 1 - value;
}

void convert_sigin_zstepper_position(data_t *data) {
    float value = data->VARIN32_STEPDIR3_POSITION;
    float offset = *data->SIGIN_ZSTEPPER_POSITION_OFFSET;
    float scale = *data->SIGIN_ZSTEPPER_POSITION_SCALE;
    float last_value = *data->SIGIN_ZSTEPPER_POSITION;
    static float last_raw_value = 0.0;
    float raw_value = value;
    value = value + offset;
    value = value / scale;
    *data->SIGIN_ZSTEPPER_POSITION_ABS = abs(value);
    *data->SIGIN_ZSTEPPER_POSITION_S32 = value;
    *data->SIGIN_ZSTEPPER_POSITION_U32_ABS = abs(value);
    *data->SIGIN_ZSTEPPER_POSITION = value;

    last_raw_value = raw_value;
}

void convert_sigin_ystepper_position(data_t *data) {
    float value = data->VARIN32_STEPDIR4_POSITION;
    float offset = *data->SIGIN_YSTEPPER_POSITION_OFFSET;
    float scale = *data->SIGIN_YSTEPPER_POSITION_SCALE;
    float last_value = *data->SIGIN_YSTEPPER_POSITION;
    static float last_raw_value = 0.0;
    float raw_value = value;
    value = value + offset;
    value = value / scale;
    *data->SIGIN_YSTEPPER_POSITION_ABS = abs(value);
    *data->SIGIN_YSTEPPER_POSITION_S32 = value;
    *data->SIGIN_YSTEPPER_POSITION_U32_ABS = abs(value);
    *data->SIGIN_YSTEPPER_POSITION = value;

    last_raw_value = raw_value;
}

void convert_sigin_xstepper_position(data_t *data) {
    float value = data->VARIN32_STEPDIR5_POSITION;
    float offset = *data->SIGIN_XSTEPPER_POSITION_OFFSET;
    float scale = *data->SIGIN_XSTEPPER_POSITION_SCALE;
    float last_value = *data->SIGIN_XSTEPPER_POSITION;
    static float last_raw_value = 0.0;
    float raw_value = value;
    value = value + offset;
    value = value / scale;
    *data->SIGIN_XSTEPPER_POSITION_ABS = abs(value);
    *data->SIGIN_XSTEPPER_POSITION_S32 = value;
    *data->SIGIN_XSTEPPER_POSITION_U32_ABS = abs(value);
    *data->SIGIN_XSTEPPER_POSITION = value;

    last_raw_value = raw_value;
}

void convert_sigin_estop_bit(data_t *data) {
    bool value = data->VARIN1_BITIN6_BIT;
    *data->SIGIN_ESTOP_BIT = value;
    *data->SIGIN_ESTOP_BIT_not = 1 - value;
}

void convert_sigin_zhome_bit(data_t *data) {
    bool value = data->VARIN1_BITIN7_BIT;
    *data->SIGIN_ZHOME_BIT = value;
    *data->SIGIN_ZHOME_BIT_not = 1 - value;
}

void convert_sigin_yhome_bit(data_t *data) {
    bool value = data->VARIN1_BITIN8_BIT;
    *data->SIGIN_YHOME_BIT = value;
    *data->SIGIN_YHOME_BIT_not = 1 - value;
}

void convert_sigin_xhome_bit(data_t *data) {
    bool value = data->VARIN1_BITIN9_BIT;
    *data->SIGIN_XHOME_BIT = value;
    *data->SIGIN_XHOME_BIT_not = 1 - value;
}
...
void convert_outputs(void) {
    ...
    convert_varout32_pwmout2_dty(data);
    convert_varout1_pwmout2_enable(data);
...
void convert_inputs(void) {
    // input: rxBuffer -> VAROUT -> calc -> SIGOUT
    convert_sigin_spindle_rpm_in_frequency(data);
    convert_sigin_spindle_rpm_in_valid(data);
    convert_sigin_zstepper_position(data);
    convert_sigin_ystepper_position(data);
    convert_sigin_xstepper_position(data);
    convert_sigin_estop_bit(data);
    convert_sigin_zhome_bit(data);
    convert_sigin_yhome_bit(data);
    convert_sigin_xhome_bit(data);
}
...
void write_txbuffer(uint8_t *txBuffer) {
    ...
    txBuffer[2] = 0x72;
    txBuffer[3] = 0x77;
    memcpy(&txBuffer[4], &data->VAROUT32_PWMOUT2_DTY, 4);
    memcpy(&txBuffer[8], &data->VAROUT32_STEPDIR3_VELOCITY, 4);
    memcpy(&txBuffer[12], &data->VAROUT32_STEPDIR4_VELOCITY, 4);
    memcpy(&txBuffer[16], &data->VAROUT32_STEPDIR5_VELOCITY, 4);
    txBuffer[20] |= (data->VAROUT1_PWMOUT2_ENABLE<<7);
...
void read_rxbuffer(uint8_t *rxBuffer) {
    ...
    memcpy(&data->VARIN32_FREQIN1_FREQUENCY, &rxBuffer[4], 4);
    memcpy(&data->VARIN32_STEPDIR3_POSITION, &rxBuffer[8], 4);
    memcpy(&data->VARIN32_STEPDIR4_POSITION, &rxBuffer[12], 4);
    memcpy(&data->VARIN32_STEPDIR5_POSITION, &rxBuffer[16], 4);
    data->VARIN1_FREQIN1_VALID = (rxBuffer[20] & (1<<7));
    data->VARIN1_BITIN6_BIT = (rxBuffer[20] & (1<<6));
    data->VARIN1_BITIN7_BIT = (rxBuffer[20] & (1<<5));
    data->VARIN1_BITIN8_BIT = (rxBuffer[20] & (1<<4));
    data->VARIN1_BITIN9_BIT = (rxBuffer[20] & (1<<3));
}
