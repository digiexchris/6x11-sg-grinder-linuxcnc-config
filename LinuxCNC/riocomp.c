...
typedef struct {
    ...
    hal_float_t *SIGIN_STEPPER4_POSITION;
    hal_float_t *SIGIN_STEPPER4_POSITION_ABS;
    hal_s32_t *SIGIN_STEPPER4_POSITION_S32;
    hal_u32_t *SIGIN_STEPPER4_POSITION_U32_ABS;
    hal_float_t *SIGIN_STEPPER4_POSITION_SCALE;
    hal_float_t *SIGIN_STEPPER4_POSITION_OFFSET;
    hal_bit_t   *SIGOUT_STEPPER4_ENABLE;
    hal_float_t *SIGOUT_STEPPER5_VELOCITY;
    hal_float_t *SIGOUT_STEPPER5_VELOCITY_SCALE;
    hal_float_t *SIGOUT_STEPPER5_VELOCITY_OFFSET;
    hal_float_t *SIGIN_STEPPER5_POSITION;
    hal_float_t *SIGIN_STEPPER5_POSITION_ABS;
    hal_s32_t *SIGIN_STEPPER5_POSITION_S32;
    hal_u32_t *SIGIN_STEPPER5_POSITION_U32_ABS;
    hal_float_t *SIGIN_STEPPER5_POSITION_SCALE;
    hal_float_t *SIGIN_STEPPER5_POSITION_OFFSET;
    hal_bit_t   *SIGOUT_STEPPER5_ENABLE;
    hal_float_t *SIGOUT_STEPPER6_VELOCITY;
    hal_float_t *SIGOUT_STEPPER6_VELOCITY_SCALE;
    hal_float_t *SIGOUT_STEPPER6_VELOCITY_OFFSET;
    hal_float_t *SIGIN_STEPPER6_POSITION;
    hal_float_t *SIGIN_STEPPER6_POSITION_ABS;
    hal_s32_t *SIGIN_STEPPER6_POSITION_S32;
    hal_u32_t *SIGIN_STEPPER6_POSITION_U32_ABS;
    hal_float_t *SIGIN_STEPPER6_POSITION_SCALE;
    hal_float_t *SIGIN_STEPPER6_POSITION_OFFSET;
    hal_bit_t   *SIGOUT_STEPPER6_ENABLE;
    hal_bit_t   *SIGOUT_OUTPUT1_BIT;
    hal_bit_t   *SIGOUT_OUTPUT2_BIT;
    hal_bit_t   *SIGOUT_LED_BIT;
    hal_bit_t   *SIGIN_INPUT1_BIT;
    hal_bit_t   *SIGIN_INPUT1_BIT_not;
    hal_bit_t   *SIGIN_INPUT2_BIT;
    hal_bit_t   *SIGIN_INPUT2_BIT_not;
    hal_bit_t   *SIGIN_INPUT3_BIT;
    hal_bit_t   *SIGIN_INPUT3_BIT_not;
    hal_bit_t   *SIGIN_INPUT4_BIT;
    hal_bit_t   *SIGIN_INPUT4_BIT_not;
    ...
    int32_t VAROUT32_STEPDIR6_VELOCITY;
    int32_t VARIN32_STEPDIR6_POSITION;
    int32_t VAROUT32_STEPDIR7_VELOCITY;
    int32_t VARIN32_STEPDIR7_POSITION;
    int32_t VAROUT32_STEPDIR8_VELOCITY;
    int32_t VARIN32_STEPDIR8_POSITION;
    bool VAROUT1_BITOUT2_BIT;
    bool VAROUT1_STEPDIR3_ENABLE;
    bool VAROUT1_STEPDIR4_ENABLE;
    bool VAROUT1_STEPDIR5_ENABLE;
    bool VAROUT1_STEPDIR6_ENABLE;
    bool VAROUT1_STEPDIR7_ENABLE;
    bool VAROUT1_STEPDIR8_ENABLE;
    bool VAROUT1_BITOUT9_BIT;
    bool VAROUT1_BITOUT10_BIT;
    bool VAROUT1_BITOUT11_BIT;
    bool VARIN1_BITIN12_BIT;
    bool VARIN1_BITIN13_BIT;
    bool VARIN1_BITIN14_BIT;
    bool VARIN1_BITIN15_BIT;
    bool VARIN1_BITIN16_BIT;
    bool VARIN1_BITIN17_BIT;
    bool VARIN1_BITIN18_BIT;
    bool VARIN1_BITIN19_BIT;
...
void register_signals(void) {
    ...
    data->VAROUT32_STEPDIR6_VELOCITY = 0;
    data->VARIN32_STEPDIR6_POSITION = 0;
    data->VAROUT32_STEPDIR7_VELOCITY = 0;
    data->VARIN32_STEPDIR7_POSITION = 0;
    data->VAROUT32_STEPDIR8_VELOCITY = 0;
    data->VARIN32_STEPDIR8_POSITION = 0;
    data->VAROUT1_BITOUT2_BIT = 0;
    data->VAROUT1_STEPDIR3_ENABLE = 0;
    data->VAROUT1_STEPDIR4_ENABLE = 0;
    data->VAROUT1_STEPDIR5_ENABLE = 0;
    data->VAROUT1_STEPDIR6_ENABLE = 0;
    data->VAROUT1_STEPDIR7_ENABLE = 0;
    data->VAROUT1_STEPDIR8_ENABLE = 0;
    data->VAROUT1_BITOUT9_BIT = 0;
    data->VAROUT1_BITOUT10_BIT = 0;
    data->VAROUT1_BITOUT11_BIT = 0;
    data->VARIN1_BITIN12_BIT = 0;
    data->VARIN1_BITIN13_BIT = 0;
    data->VARIN1_BITIN14_BIT = 0;
    data->VARIN1_BITIN15_BIT = 0;
    data->VARIN1_BITIN16_BIT = 0;
    data->VARIN1_BITIN17_BIT = 0;
    data->VARIN1_BITIN18_BIT = 0;
    data->VARIN1_BITIN19_BIT = 0;
    ...
    *data->SIGOUT_STEPPER4_VELOCITY_OFFSET = 0.0;
    if (retval = hal_pin_float_newf(HAL_IN, &(data->SIGOUT_STEPPER4_VELOCITY), comp_id, "%s.Stepper4.velocity", prefix) != 0) error_handler(retval);
    *data->SIGOUT_STEPPER4_VELOCITY = 0;
    if (retval = hal_pin_float_newf(HAL_IN, &(data->SIGIN_STEPPER4_POSITION_SCALE), comp_id, "%s.Stepper4.position-scale", prefix) != 0) error_handler(retval);
    *data->SIGIN_STEPPER4_POSITION_SCALE = 1.0;
    if (retval = hal_pin_float_newf(HAL_IN, &(data->SIGIN_STEPPER4_POSITION_OFFSET), comp_id, "%s.Stepper4.position-offset", prefix) != 0) error_handler(retval);
    *data->SIGIN_STEPPER4_POSITION_OFFSET = 0.0;
    if (retval = hal_pin_float_newf(HAL_OUT, &(data->SIGIN_STEPPER4_POSITION), comp_id, "%s.Stepper4.position", prefix) != 0) error_handler(retval);
    *data->SIGIN_STEPPER4_POSITION = 0;
    if (retval = hal_pin_float_newf(HAL_OUT, &(data->SIGIN_STEPPER4_POSITION_ABS), comp_id, "%s.Stepper4.position-abs", prefix) != 0) error_handler(retval);
    *data->SIGIN_STEPPER4_POSITION_ABS = 0;
    if (retval = hal_pin_s32_newf(HAL_OUT, &(data->SIGIN_STEPPER4_POSITION_S32), comp_id, "%s.Stepper4.position-s32", prefix) != 0) error_handler(retval);
    *data->SIGIN_STEPPER4_POSITION_S32 = 0;
    if (retval = hal_pin_u32_newf(HAL_OUT, &(data->SIGIN_STEPPER4_POSITION_U32_ABS), comp_id, "%s.Stepper4.position-u32-abs", prefix) != 0) error_handler(retval);
    *data->SIGIN_STEPPER4_POSITION_U32_ABS = 0;
    if (retval = hal_pin_bit_newf  (HAL_IN, &(data->SIGOUT_STEPPER4_ENABLE), comp_id, "%s.Stepper4.enable", prefix) != 0) error_handler(retval);
    *data->SIGOUT_STEPPER4_ENABLE = 0;
    if (retval = hal_pin_float_newf(HAL_IN, &(data->SIGOUT_STEPPER5_VELOCITY_SCALE), comp_id, "%s.Stepper5.velocity-scale", prefix) != 0) error_handler(retval);
    *data->SIGOUT_STEPPER5_VELOCITY_SCALE = 1.0;
    if (retval = hal_pin_float_newf(HAL_IN, &(data->SIGOUT_STEPPER5_VELOCITY_OFFSET), comp_id, "%s.Stepper5.velocity-offset", prefix) != 0) error_handler(retval);
    *data->SIGOUT_STEPPER5_VELOCITY_OFFSET = 0.0;
    if (retval = hal_pin_float_newf(HAL_IN, &(data->SIGOUT_STEPPER5_VELOCITY), comp_id, "%s.Stepper5.velocity", prefix) != 0) error_handler(retval);
    *data->SIGOUT_STEPPER5_VELOCITY = 0;
    if (retval = hal_pin_float_newf(HAL_IN, &(data->SIGIN_STEPPER5_POSITION_SCALE), comp_id, "%s.Stepper5.position-scale", prefix) != 0) error_handler(retval);
    *data->SIGIN_STEPPER5_POSITION_SCALE = 1.0;
    if (retval = hal_pin_float_newf(HAL_IN, &(data->SIGIN_STEPPER5_POSITION_OFFSET), comp_id, "%s.Stepper5.position-offset", prefix) != 0) error_handler(retval);
    *data->SIGIN_STEPPER5_POSITION_OFFSET = 0.0;
    if (retval = hal_pin_float_newf(HAL_OUT, &(data->SIGIN_STEPPER5_POSITION), comp_id, "%s.Stepper5.position", prefix) != 0) error_handler(retval);
    *data->SIGIN_STEPPER5_POSITION = 0;
    if (retval = hal_pin_float_newf(HAL_OUT, &(data->SIGIN_STEPPER5_POSITION_ABS), comp_id, "%s.Stepper5.position-abs", prefix) != 0) error_handler(retval);
    *data->SIGIN_STEPPER5_POSITION_ABS = 0;
    if (retval = hal_pin_s32_newf(HAL_OUT, &(data->SIGIN_STEPPER5_POSITION_S32), comp_id, "%s.Stepper5.position-s32", prefix) != 0) error_handler(retval);
    *data->SIGIN_STEPPER5_POSITION_S32 = 0;
    if (retval = hal_pin_u32_newf(HAL_OUT, &(data->SIGIN_STEPPER5_POSITION_U32_ABS), comp_id, "%s.Stepper5.position-u32-abs", prefix) != 0) error_handler(retval);
    *data->SIGIN_STEPPER5_POSITION_U32_ABS = 0;
    if (retval = hal_pin_bit_newf  (HAL_IN, &(data->SIGOUT_STEPPER5_ENABLE), comp_id, "%s.Stepper5.enable", prefix) != 0) error_handler(retval);
    *data->SIGOUT_STEPPER5_ENABLE = 0;
    if (retval = hal_pin_float_newf(HAL_IN, &(data->SIGOUT_STEPPER6_VELOCITY_SCALE), comp_id, "%s.Stepper6.velocity-scale", prefix) != 0) error_handler(retval);
    *data->SIGOUT_STEPPER6_VELOCITY_SCALE = 1.0;
    if (retval = hal_pin_float_newf(HAL_IN, &(data->SIGOUT_STEPPER6_VELOCITY_OFFSET), comp_id, "%s.Stepper6.velocity-offset", prefix) != 0) error_handler(retval);
    *data->SIGOUT_STEPPER6_VELOCITY_OFFSET = 0.0;
    if (retval = hal_pin_float_newf(HAL_IN, &(data->SIGOUT_STEPPER6_VELOCITY), comp_id, "%s.Stepper6.velocity", prefix) != 0) error_handler(retval);
    *data->SIGOUT_STEPPER6_VELOCITY = 0;
    if (retval = hal_pin_float_newf(HAL_IN, &(data->SIGIN_STEPPER6_POSITION_SCALE), comp_id, "%s.Stepper6.position-scale", prefix) != 0) error_handler(retval);
    *data->SIGIN_STEPPER6_POSITION_SCALE = 1.0;
    if (retval = hal_pin_float_newf(HAL_IN, &(data->SIGIN_STEPPER6_POSITION_OFFSET), comp_id, "%s.Stepper6.position-offset", prefix) != 0) error_handler(retval);
    *data->SIGIN_STEPPER6_POSITION_OFFSET = 0.0;
    if (retval = hal_pin_float_newf(HAL_OUT, &(data->SIGIN_STEPPER6_POSITION), comp_id, "%s.Stepper6.position", prefix) != 0) error_handler(retval);
    *data->SIGIN_STEPPER6_POSITION = 0;
    if (retval = hal_pin_float_newf(HAL_OUT, &(data->SIGIN_STEPPER6_POSITION_ABS), comp_id, "%s.Stepper6.position-abs", prefix) != 0) error_handler(retval);
    *data->SIGIN_STEPPER6_POSITION_ABS = 0;
    if (retval = hal_pin_s32_newf(HAL_OUT, &(data->SIGIN_STEPPER6_POSITION_S32), comp_id, "%s.Stepper6.position-s32", prefix) != 0) error_handler(retval);
    *data->SIGIN_STEPPER6_POSITION_S32 = 0;
    if (retval = hal_pin_u32_newf(HAL_OUT, &(data->SIGIN_STEPPER6_POSITION_U32_ABS), comp_id, "%s.Stepper6.position-u32-abs", prefix) != 0) error_handler(retval);
    *data->SIGIN_STEPPER6_POSITION_U32_ABS = 0;
    if (retval = hal_pin_bit_newf  (HAL_IN, &(data->SIGOUT_STEPPER6_ENABLE), comp_id, "%s.Stepper6.enable", prefix) != 0) error_handler(retval);
    *data->SIGOUT_STEPPER6_ENABLE = 0;
    if (retval = hal_pin_bit_newf  (HAL_IN, &(data->SIGOUT_OUTPUT1_BIT), comp_id, "%s.Output1.bit", prefix) != 0) error_handler(retval);
    *data->SIGOUT_OUTPUT1_BIT = 0;
    ...
    *data->SIGOUT_LED_BIT = 0;
    if (retval = hal_pin_bit_newf  (HAL_OUT, &(data->SIGIN_INPUT1_BIT), comp_id, "%s.Input1.bit", prefix) != 0) error_handler(retval);
    *data->SIGIN_INPUT1_BIT = 0;
    if (retval = hal_pin_bit_newf  (HAL_OUT, &(data->SIGIN_INPUT1_BIT_not), comp_id, "%s.Input1.bit-not", prefix) != 0) error_handler(retval);
    *data->SIGIN_INPUT1_BIT_not = 1 - *data->SIGIN_INPUT1_BIT;
    if (retval = hal_pin_bit_newf  (HAL_OUT, &(data->SIGIN_INPUT2_BIT), comp_id, "%s.Input2.bit", prefix) != 0) error_handler(retval);
    *data->SIGIN_INPUT2_BIT = 0;
    if (retval = hal_pin_bit_newf  (HAL_OUT, &(data->SIGIN_INPUT2_BIT_not), comp_id, "%s.Input2.bit-not", prefix) != 0) error_handler(retval);
    *data->SIGIN_INPUT2_BIT_not = 1 - *data->SIGIN_INPUT2_BIT;
    if (retval = hal_pin_bit_newf  (HAL_OUT, &(data->SIGIN_INPUT3_BIT), comp_id, "%s.Input3.bit", prefix) != 0) error_handler(retval);
    *data->SIGIN_INPUT3_BIT = 0;
    if (retval = hal_pin_bit_newf  (HAL_OUT, &(data->SIGIN_INPUT3_BIT_not), comp_id, "%s.Input3.bit-not", prefix) != 0) error_handler(retval);
    *data->SIGIN_INPUT3_BIT_not = 1 - *data->SIGIN_INPUT3_BIT;
    if (retval = hal_pin_bit_newf  (HAL_OUT, &(data->SIGIN_INPUT4_BIT), comp_id, "%s.Input4.bit", prefix) != 0) error_handler(retval);
    *data->SIGIN_INPUT4_BIT = 0;
    if (retval = hal_pin_bit_newf  (HAL_OUT, &(data->SIGIN_INPUT4_BIT_not), comp_id, "%s.Input4.bit-not", prefix) != 0) error_handler(retval);
    *data->SIGIN_INPUT4_BIT_not = 1 - *data->SIGIN_INPUT4_BIT;
...
void convert_varout32_stepdir6_velocity(data_t *data){
    float value = *data->SIGOUT_STEPPER4_VELOCITY;
    value = value * *data->SIGOUT_STEPPER4_VELOCITY_SCALE;
    value = value + *data->SIGOUT_STEPPER4_VELOCITY_OFFSET;
    if (value != 0) {
                value = OSC_CLOCK / value / 2;
            }
    data->VAROUT32_STEPDIR6_VELOCITY = value;
}

void convert_varout1_stepdir6_enable(data_t *data){
    bool value = *data->SIGOUT_STEPPER4_ENABLE;
    
    data->VAROUT1_STEPDIR6_ENABLE = value;
}

void convert_varout32_stepdir7_velocity(data_t *data){
    float value = *data->SIGOUT_STEPPER5_VELOCITY;
    value = value * *data->SIGOUT_STEPPER5_VELOCITY_SCALE;
    value = value + *data->SIGOUT_STEPPER5_VELOCITY_OFFSET;
    if (value != 0) {
                value = OSC_CLOCK / value / 2;
            }
    data->VAROUT32_STEPDIR7_VELOCITY = value;
}

void convert_varout1_stepdir7_enable(data_t *data){
    bool value = *data->SIGOUT_STEPPER5_ENABLE;
    
    data->VAROUT1_STEPDIR7_ENABLE = value;
}

void convert_varout32_stepdir8_velocity(data_t *data){
    float value = *data->SIGOUT_STEPPER6_VELOCITY;
    value = value * *data->SIGOUT_STEPPER6_VELOCITY_SCALE;
    value = value + *data->SIGOUT_STEPPER6_VELOCITY_OFFSET;
    if (value != 0) {
                value = OSC_CLOCK / value / 2;
            }
    data->VAROUT32_STEPDIR8_VELOCITY = value;
}

void convert_varout1_stepdir8_enable(data_t *data){
    bool value = *data->SIGOUT_STEPPER6_ENABLE;
    
    data->VAROUT1_STEPDIR8_ENABLE = value;
}

void convert_varout1_bitout9_bit(data_t *data){
    bool value = *data->SIGOUT_OUTPUT1_BIT;
    
    data->VAROUT1_BITOUT9_BIT = value;
}

void convert_varout1_bitout10_bit(data_t *data){
    bool value = *data->SIGOUT_OUTPUT2_BIT;
    
    data->VAROUT1_BITOUT10_BIT = value;
}

void convert_varout1_bitout11_bit(data_t *data){
    bool value = *data->SIGOUT_LED_BIT;
    
    data->VAROUT1_BITOUT11_BIT = value;
}
...
void convert_sigin_stepper4_position(data_t *data) {
    float value = data->VARIN32_STEPDIR6_POSITION;
    float offset = *data->SIGIN_STEPPER4_POSITION_OFFSET;
    float scale = *data->SIGIN_STEPPER4_POSITION_SCALE;
    float last_value = *data->SIGIN_STEPPER4_POSITION;
    static float last_raw_value = 0.0;
    float raw_value = value;
    value = value + offset;
    value = value / scale;
    *data->SIGIN_STEPPER4_POSITION_ABS = abs(value);
    *data->SIGIN_STEPPER4_POSITION_S32 = value;
    *data->SIGIN_STEPPER4_POSITION_U32_ABS = abs(value);
    *data->SIGIN_STEPPER4_POSITION = value;

    last_raw_value = raw_value;
}

void convert_sigin_stepper5_position(data_t *data) {
    float value = data->VARIN32_STEPDIR7_POSITION;
    float offset = *data->SIGIN_STEPPER5_POSITION_OFFSET;
    float scale = *data->SIGIN_STEPPER5_POSITION_SCALE;
    float last_value = *data->SIGIN_STEPPER5_POSITION;
    static float last_raw_value = 0.0;
    float raw_value = value;
    value = value + offset;
    value = value / scale;
    *data->SIGIN_STEPPER5_POSITION_ABS = abs(value);
    *data->SIGIN_STEPPER5_POSITION_S32 = value;
    *data->SIGIN_STEPPER5_POSITION_U32_ABS = abs(value);
    *data->SIGIN_STEPPER5_POSITION = value;

    last_raw_value = raw_value;
}

void convert_sigin_stepper6_position(data_t *data) {
    float value = data->VARIN32_STEPDIR8_POSITION;
    float offset = *data->SIGIN_STEPPER6_POSITION_OFFSET;
    float scale = *data->SIGIN_STEPPER6_POSITION_SCALE;
    float last_value = *data->SIGIN_STEPPER6_POSITION;
    static float last_raw_value = 0.0;
    float raw_value = value;
    value = value + offset;
    value = value / scale;
    *data->SIGIN_STEPPER6_POSITION_ABS = abs(value);
    *data->SIGIN_STEPPER6_POSITION_S32 = value;
    *data->SIGIN_STEPPER6_POSITION_U32_ABS = abs(value);
    *data->SIGIN_STEPPER6_POSITION = value;

    last_raw_value = raw_value;
}

void convert_sigin_input1_bit(data_t *data) {
    bool value = data->VARIN1_BITIN12_BIT;
    *data->SIGIN_INPUT1_BIT = value;
    *data->SIGIN_INPUT1_BIT_not = 1 - value;
}

void convert_sigin_input2_bit(data_t *data) {
    bool value = data->VARIN1_BITIN13_BIT;
    *data->SIGIN_INPUT2_BIT = value;
    *data->SIGIN_INPUT2_BIT_not = 1 - value;
}

void convert_sigin_input3_bit(data_t *data) {
    bool value = data->VARIN1_BITIN14_BIT;
    *data->SIGIN_INPUT3_BIT = value;
    *data->SIGIN_INPUT3_BIT_not = 1 - value;
}

void convert_sigin_input4_bit(data_t *data) {
    bool value = data->VARIN1_BITIN15_BIT;
    *data->SIGIN_INPUT4_BIT = value;
    *data->SIGIN_INPUT4_BIT_not = 1 - value;
}

void convert_sigin_input5_bit(data_t *data) {
    bool value = data->VARIN1_BITIN16_BIT;
    *data->SIGIN_INPUT5_BIT = value;
    *data->SIGIN_INPUT5_BIT_not = 1 - value;
}

void convert_sigin_input6_bit(data_t *data) {
    bool value = data->VARIN1_BITIN17_BIT;
    *data->SIGIN_INPUT6_BIT = value;
    *data->SIGIN_INPUT6_BIT_not = 1 - value;
}

void convert_sigin_input7_bit(data_t *data) {
    bool value = data->VARIN1_BITIN18_BIT;
    *data->SIGIN_INPUT7_BIT = value;
    *data->SIGIN_INPUT7_BIT_not = 1 - value;
}

void convert_sigin_input8_bit(data_t *data) {
    bool value = data->VARIN1_BITIN19_BIT;
...
void convert_outputs(void) {
    ...
    convert_varout32_stepdir6_velocity(data);
    convert_varout1_stepdir6_enable(data);
    convert_varout32_stepdir7_velocity(data);
    convert_varout1_stepdir7_enable(data);
    convert_varout32_stepdir8_velocity(data);
    convert_varout1_stepdir8_enable(data);
    convert_varout1_bitout9_bit(data);
    convert_varout1_bitout10_bit(data);
    convert_varout1_bitout11_bit(data);
}
...
void convert_inputs(void) {
    ...
    convert_sigin_input1_bit(data);
    convert_sigin_input2_bit(data);
    convert_sigin_input3_bit(data);
    convert_sigin_input4_bit(data);
...
void write_txbuffer(uint8_t *txBuffer) {
    ...
    memcpy(&txBuffer[16], &data->VAROUT32_STEPDIR6_VELOCITY, 4);
    memcpy(&txBuffer[20], &data->VAROUT32_STEPDIR7_VELOCITY, 4);
    memcpy(&txBuffer[24], &data->VAROUT32_STEPDIR8_VELOCITY, 4);
    txBuffer[28] |= (data->VAROUT1_BITOUT2_BIT<<7);
    txBuffer[28] |= (data->VAROUT1_STEPDIR3_ENABLE<<6);
    txBuffer[28] |= (data->VAROUT1_STEPDIR4_ENABLE<<5);
    txBuffer[28] |= (data->VAROUT1_STEPDIR5_ENABLE<<4);
    txBuffer[28] |= (data->VAROUT1_STEPDIR6_ENABLE<<3);
    txBuffer[28] |= (data->VAROUT1_STEPDIR7_ENABLE<<2);
    txBuffer[28] |= (data->VAROUT1_STEPDIR8_ENABLE<<1);
    txBuffer[28] |= (data->VAROUT1_BITOUT9_BIT<<0);
    txBuffer[29] |= (data->VAROUT1_BITOUT10_BIT<<7);
    txBuffer[29] |= (data->VAROUT1_BITOUT11_BIT<<6);
}
...
void read_rxbuffer(uint8_t *rxBuffer) {
    ...
    memcpy(&data->VARIN32_STEPDIR6_POSITION, &rxBuffer[16], 4);
    memcpy(&data->VARIN32_STEPDIR7_POSITION, &rxBuffer[20], 4);
    memcpy(&data->VARIN32_STEPDIR8_POSITION, &rxBuffer[24], 4);
    data->VARIN1_BITIN12_BIT = (rxBuffer[28] & (1<<7));
    data->VARIN1_BITIN13_BIT = (rxBuffer[28] & (1<<6));
    data->VARIN1_BITIN14_BIT = (rxBuffer[28] & (1<<5));
    data->VARIN1_BITIN15_BIT = (rxBuffer[28] & (1<<4));
    data->VARIN1_BITIN16_BIT = (rxBuffer[28] & (1<<3));
    data->VARIN1_BITIN17_BIT = (rxBuffer[28] & (1<<2));
    data->VARIN1_BITIN18_BIT = (rxBuffer[28] & (1<<1));
    data->VARIN1_BITIN19_BIT = (rxBuffer[28] & (1<<0));
}
